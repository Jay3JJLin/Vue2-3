<template>
  <div class="box">
    ...
    <!-- 访问模块中的actions - 通过辅助函数mapActions -->
    <br />
    <button @click="setUserAction({ name: 'giao', age: 361 })">一秒后更新个人信息</button>
    <button @click="setThemeAction('yellow')">一秒后更新主题色</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('user', ['setUserAction']), // 子模块的actions
    ...mapActions('setting', ['setThemeAction'])
  }
}
</script>
