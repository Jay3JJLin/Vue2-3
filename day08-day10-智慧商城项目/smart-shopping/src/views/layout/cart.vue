        ...
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <!-- 既希望保留原本的形参，又需要通过函数调用传参 --=> 箭头函数包装一层-->
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          <div class="price">
            <span>合计：</span>
            <span>
              ¥ <i class="totalPrice">{{ selPrice }}</i>
            </span>
          </div>
          <!-- 注意：选中的商品数为0时，禁用结算和删除 -->
          <!-- 不是编辑状态则结算，是就删除 -->
...
export default {
  ...
  methods: {
    ...
    toggleAllCheck () {
      // 提交触发模块中的mutation，重置全选状态，取反
      this.$store.commit('cart/toggleAllCheck', !this.isAllChecked)
    },
    changeCount (goodsNum, goodsId, goodsSkuId) {
      // 调用 vuex 的action, 进行数量的修改
